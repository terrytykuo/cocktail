...
class ResDAE(nn.Module):
    def __init__(self):
        ...
        self.upward_net8 = nn.Sequential(
            nn.Conv2d(in_channels=512, out_channels=512, kernel_size=(2,2), stride=2),
            nn.ReLU(),
            ResBlock(512, 512),
            ResBlock(512, 1024),
            ResBlock(1024, 1024),
...
#            nn.ConvTranspose2d(8, 8, kernel_size = (2,2), stride = 2),
    ...
    def upward(self, x, a8 =None, a7=None, a6=None, a5=None, a4=None, a3=None, a2=None):
...
#        print ("after conv7", x.shape)
        ...
        x = self.upward_net8(x)
        if a8 is not None: x = x * a8
#        print ("after conv7", x.shape)
...
# model = ResDAE()
model = torch.load(root_dir + 'DAE-FC.pkl')
# print (model)
...
for epo in range(epoch):
    for i, data in enumerate(trainloader, 0):
        ...
        if i % 50 == 0:
            ...
            cv2.imwrite("/home/tk/Documents/recover/1024x1x1/" + str(epo) + "_" + str(i) + ".png", inn)
            
            out = outputs[0].view(128, 128).detach().numpy() * 255
            cv2.imwrite("/home/tk/Documents/recover/1024x1x1/" + str(epo) + "_" + str(i) + "_re.png", out)
...
torch.save(model, root_dir + 'DAE-FC.pkl')
